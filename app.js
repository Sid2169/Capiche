...
const walking_outside_namespaceObject = __webpack_require__.p + "images/img_239a64d4e8d5acda48e5.png";
...
const ui_account_darkOverlay = document.querySelector(".dark-overlay");
...
function openAccountModal() {
  ...
  ui_account_darkOverlay.classList.add("active");
  loadAccount();
}

function closeAccountModal() {
  accountModal.classList.remove("active");
  ui_account_darkOverlay.classList.remove("active");
}

accountBtn.addEventListener("click", openAccountModal);
accountCloseBtn.addEventListener("click", closeAccountModal);
ui_account_darkOverlay.addEventListener("click", closeAccountModal);
